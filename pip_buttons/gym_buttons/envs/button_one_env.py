...
class ButtonOneEnv(gym.Env):
    ...
    def _render(self, mode='human', close=False):
        ...
        agent_x, goal_x = self.state
        self.man_trans.set_translation(agent_x*4, 200)
        self.goal_trans.set_translation(goal_x*4, 200)
